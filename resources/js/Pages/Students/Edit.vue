...
let student=usePage().props.student.data
 ...
 const form=useForm({
    ...
    section_id:student.sections.id,
 });
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        >
                                            ...
                                            <option :key="item.id" :value="item.id" v-for="item in classes.data">{{item.name}}</option>
                                        </select>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        >
                                            ...
                                            <option value="1" v-for="section in sections.data" :value="section.id" >{{section.name}}</option>
                                        </select>
